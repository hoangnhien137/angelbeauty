...
if ( get_option('woocommerce_prepend_shop_page_to_urls') == "yes" && woocommerce_get_page_id( 'webshop' ) && get_option( 'page_on_front' ) !== woocommerce_get_page_id( 'webshop' ) )
	$prepend =  $before . '<a href="' . get_permalink( woocommerce_get_page_id('webshop') ) . '">' . get_the_title( woocommerce_get_page_id('webshop') ) . '</a> ' . $after . $delimiter;
else
	$prepend = '';

if ( ( ! is_home() && ! is_front_page() && ! ( is_post_type_archive() && get_option( 'page_on_front' ) == woocommerce_get_page_id( 'webshop' ) ) ) || is_paged() ) {
	...
	} elseif ( is_post_type_archive('product') && get_option('page_on_front') !== woocommerce_get_page_id('webshop') ) {

		$_name = woocommerce_get_page_id( 'webshop' ) ? get_the_title( woocommerce_get_page_id( 'webshop' ) ) : ucwords( get_option( 'woocommerce_shop_slug' ) );
